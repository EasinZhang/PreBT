...
class Options(object):
    ...
    def __init__(self):
        ...
        # I/O
        self.parser.add_argument('--output_dir', default='./src/output',
                                 help='Root output directory. Must exist. Time-stamped directories will be created inside.')
        self.parser.add_argument('--data_dir', default='./src/data/Reconstruct/train',
                                 help='Data directory')
        ...
        self.parser.add_argument('--n_proc', type=int, default=8,
        ...
        self.parser.add_argument('--data_class', type=str, choices={'reconstructdataset', 'sohdataset', 'socdataset', 'sotdataset'}, default='reconstructdataset',
        ...
        self.parser.add_argument('--normalization',
                                 choices={'standardization', 'minmax2', 'minmax', 'per_sample_std', 'per_sample_minmax', 'revin' },
                                 default='minmax',
        ...
        self.parser.add_argument('--forecast', action='store_true',
                                 help='If set, forecasting the voltages')
        ...
        self.parser.add_argument('--warmup_ration', type=float, default=0.1, help='')
        self.parser.add_argument('--initial_lr', type=float, default=1e-6, help='')
        self.parser.add_argument('--min_lr', type=float, default=1e-6, help='')
        ...
        # Model
        self.parser.add_argument('--model', choices={"transformer",'BBTE'}, default="BBTE",
                                 help="Model class")
        ...
        self.parser.add_argument('--num_layers', type=int, default=8,
        ...
        self.parser.add_argument('--normalization_layer', choices={'BatchNorm', 'LayerNorm'}, default='LayerNorm',
