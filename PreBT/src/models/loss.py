...
def get_loss_module(config):
    ...
    if task == "regression" and config['data_class'] == 'socdataset':
        return nn.MSELoss(reduction='none')
    if task == "regression" and config['data_class'] == 'sotdataset':
        return nn.MSELoss(reduction='none')
    if task == "regression" and config['data_class'] == 'sohdataset':
        return nn.MSELoss(reduction='none')
